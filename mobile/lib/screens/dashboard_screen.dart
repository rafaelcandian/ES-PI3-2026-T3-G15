        ...
        children: [
          Column(
            ...
            children: [
              ...
              const Text(
                '320 Tokens',
                style: TextStyle(color: Color(0xFF7D91C2), fontSize: 12),
              ),
            ],
          ),
          Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  color: isNegative
                      ? const Color(0xFFEC5D71)
                      : const Color(0xFF43D672),
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
                ),
              ),
  ...
  Widget _buildHistoryRow(String date, String startup, String type) {
    return Row(
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                date,
                style: const TextStyle(color: Color(0xFF7D91C2), fontSize: 12),
              ),
              const SizedBox(height: 4),
              Text(
                startup,
        ...
        Text(
          type,
          style: const TextStyle(color: Color(0xFF9CADDD), fontSize: 12),
        ),
      ],
    );
  }
